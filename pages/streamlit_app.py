...
with cols[0]:
    ...
    st.page_link("pages/fred.py", label="Talk to Fred →", use_container_width=True)
...
with cols[1]:
    ...
    st.page_link("pages/greg.py", label="Talk to Greg →", use_container_width=True)
...
with cols[2]:
    ...
    st.page_link("pages/nurse_zoey_zoe.py", label="Talk to Nurse Zoey Zoe →", use_container_width=True)
