...
# Florida-themed CSS - clean cards, no extra bubbles, consistent button alignment
st.markdown("""
<style>
    .stApp {
    ...
    .agent-desc {
        min-height: 110px;  /* Ensures all descriptions take same space */
        font-size: 1.1rem;
        line-height: 1.6;
        margin: 1rem 0;
    }
    ...
    /* Remove any unwanted Streamlit backgrounds/bubbles */
...
with cols[1]:
    ...
    st.markdown("<div class='agent-desc'>*YOUR PERSONAL TRAINER* <br>A motivated lifestyle coach and fitness professional. Let start with a workout routine tailored to your fitness goals and health needs.</div>", unsafe_allow_html=True)
...
# Model name - valid and current as of Dec 2025
