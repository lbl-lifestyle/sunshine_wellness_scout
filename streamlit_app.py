...
st.image("https://i.postimg.cc/tgsgw1dW/image.jpg", use_column_width=True, caption="Your Florida Longevity Lifestyle – Active Trails at Sunset")
...
with cols[0]:
    ...
    st.markdown("*WELLNESS HOME SCOUT*  \nA goal-focused realtor. Lets start by generating a detailed report of home options that match you lifestyle needs.")
...
with cols[1]:
    ...
    st.markdown("*PERSONAL TRAINER*  \nA motivated lifestyle coach. Let start with a workout routine tailored to you fitness goals and health needs")
...
with cols[2]:
    ...
    st.markdown("*Health Assessor*  \nA compassionate wellness guide. Ask Zoey any health question. She can help you develop a proactive health lifestyle")
...
if st.session_state.selected_agent == "fred":
    ...
    st.success("**The report generated by this tool is completely free – no cost, no obligation!  You will recieve five total tailored recommendations.  The first two recommendations immediately. You will then recieve the full report via email.**")
    st.write("The perfect Florida home that supports your lifestyle awaits.")

    st.image("https://i.postimg.cc/fRms9xv6/tierra-mallorca-rg-J1J8SDEAY-unsplash.jpg", use_column_width=True, caption="Community wellness – part of your Florida longevity lifestyle")

    client_needs = st.text_area("Describe your dream wellness/active home.  Let Fred do the rest!!!", height=220, placeholder="Example: Active couple in our 40s, love trails and home workouts, need gym space, near nature, budget $500k...")
